...
plt.plot(time, ORB_process_time, marker="+",label='ORB-SLAM2', linewidth=1)
plt.plot(time, OKVIS_process_time,marker="+", label='OKVIS', linewidth=1)
plt.plot(time, SPVI_process_time, marker="+",label='SPVI-SLAM', linewidth=1)

plt.xlim(0, (len(SPVI_process_time))/20.0)
